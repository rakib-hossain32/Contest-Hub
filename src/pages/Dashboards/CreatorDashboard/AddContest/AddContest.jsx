            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#00b074] focus:ring-4 focus:ring-[#00b074]/10 outline-none transition-all bg-white"
                >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="number"
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[#00b074] focus:ring-4 focus:ring-[#00b074]/10 outline-none transition-all"
                  />
                </div>
              </div>
