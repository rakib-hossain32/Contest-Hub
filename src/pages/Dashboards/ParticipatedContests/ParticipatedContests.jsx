  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="flex items-center gap-4 p-6 bg-white border border-gray-100 shadow-sm rounded-xl">
          <div className="p-3 text-blue-600 rounded-lg bg-blue-50">
            <Calendar className="w-6 h-6" />
          </div>
          <div>
            <p className="text-sm text-gray-500">Total Participated</p>
      ...
      <div className="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
        <div className="p-6 border-b border-gray-100">
          <h3 className="font-bold text-slate-800">Participation History</h3>
        </div>
            ...
            <tbody className="divide-y divide-gray-50">
              {sortedContests.map((contest) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">${contest.fee}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right">
                    <button className="text-blue-600 hover:text-blue-700 font-medium text-xs border border-blue-200 px-3 py-1.5 rounded-lg hover:bg-blue-50 transition-all">
                      View Details
                    </button>
                  </td>
                </tr>
